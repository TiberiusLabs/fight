 ...
 */
public class MonsterListItem implements HeroItem {
    private final String classTypeName;
    private final String classTypeDescription;
    private final LayoutInflater inflater;

    public MonsterListItem(LayoutInflater inflater, String classTypeName,
    ...
    public int getViewType() {
        return NavigationArrayAdapter.RowType.LIST_ITEM_MONSTER.ordinal();
    }
